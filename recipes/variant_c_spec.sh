#!/bin/bash
# variant_c_spec.sh - SPECULATIVE trial: base config + native MTP (NEXTN).
# Capacity levers REVERTED (they regressed agg); only spec added:
#   --speculative-algorithm NEXTN (glm5_next_nextn draft integrated in repo)
